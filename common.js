// common.js — index__.html と全く同じロジック

// Settings
const focalLength = parseFloat(localStorage.getItem('focalLength')) || 5;
const sensorWidth = parseFloat(localStorage.getItem('sensorWidth')) || 5;
